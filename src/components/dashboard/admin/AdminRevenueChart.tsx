...
export function AdminRevenueChart({ data }: AdminRevenueChartProps) {
  ...
  const chartRows = useMemo(() => {
    // Basic filter by last N items assuming they are daily
    // In a real app with gaps, we'd filter by actual date difference
    ...
    <Card className="col-span-1 lg:col-span-8">
      <CardHeader>
        <DashboardSectionHeader
          ...
          description="Chiffre d'affaires global de la plateforme"
          action={
            <Select
