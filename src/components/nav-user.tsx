	...
	return (
		<DropdownMenu>
			...
			<DropdownMenuContent align="end" className="w-64">
				<DropdownMenuItem className="flex items-center justify-start gap-2 pointer-events-none">
					<DropdownMenuLabel className="flex items-center gap-3 p-0">
						...
						<div>
							...
							<div className="max-w-40 overflow-hidden text-ellipsis whitespace-nowrap text-muted-foreground text-xs">
								{user.email}
							</div>
				...
				<DropdownMenuGroup>
					<DropdownMenuItem className="cursor-pointer" onClick={() => navigate(user.role === 'admin' ? '/admin/profile' : '/dashboard/profile')}>
