...
const latestChange = {
	...
	description: "Tarifs en temps réel disponibles.", // TIP: Use a single line of text for the description. (max 5 words)
	readMore: { href: "#", label: "Voir plus" },
} as const;
...
export function LatestChange() {
	...
	return (
		...
		>
			...
			<Button className="w-max px-0 font-light text-xs" size="sm" variant="link" asChild><a href={latestChange.readMore.href}>{latestChange.readMore.label}</a></Button>
			<Button
